        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-stretch">
            ...
            <button
              ...
              className="w-full h-full rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white via-white to-primary-50 shadow-lg hover:shadow-xl p-6 sm:p-8 text-center flex items-center justify-center transition transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-primary/20"
            >
              <div className="flex flex-col items-center justify-center min-h-[240px] sm:min-h-[280px]">
                <div className="mb-4 p-3 rounded-xl bg-primary-50 inline-flex">
                ...
                <p className="mt-2 text-primary-700/80 text-xs sm:text-sm">
                  {isJoined
                    ? "Open your registered team"
                    : "Assemble your squad and compete together"}
                </p>
                <div className="mt-6 inline-flex items-center px-6 py-2 rounded-full bg-gradient-primary text-white text-xs sm:text-sm font-semibold shadow transition">
            ...
            <button
              ...
              className="group w-full h-full rounded-2xl sm:rounded-3xl overflow-hidden p-[2px] bg-gradient-primary shadow-lg transition transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-primary/40"
            >
              <div className="h-full w-full rounded-2xl sm:rounded-3xl bg-gradient-primary">
                <div className="p-6 sm:p-8 text-white flex flex-col items-center justify-center text-center min-h-[240px] sm:min-h-[280px] h-full">
                  <div className="mb-4 p-3 rounded-xl bg-white/20 backdrop-blur-sm">
                  ...
                  <p className="mt-2 text-white/90 text-xs sm:text-sm">
                    See how you rank against the best
                  </p>
                  <div className="mt-6 inline-flex items-center px-6 py-2 rounded-full bg-white/20 hover:bg-white/30 text-white text-xs sm:text-sm font-semibold transition">
                    View Rankings
                  </div>
                </div>
              </div>
