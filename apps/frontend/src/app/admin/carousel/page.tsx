                                ...
                                >
                                    ...
                                    <div className="relative h-48 bg-gray-100">
                                        ...
                                        <div className="absolute top-2 right-2">
                                            <span
                                                className={`px-3 py-1 rounded-full text-xs font-semibold ${image.active
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex gap-2 mt-4">
                                            <button
                                                ...
                                                className={`flex-1 flex items-center justify-center gap-1 px-3 py-2 rounded text-sm font-medium transition-colors ${image.active
