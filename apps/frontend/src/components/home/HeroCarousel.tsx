...
export function HeroCarousel({
    ...
    return (
        <div className={`${className}`}>
            ...
            <div
                className="relative w-full h-64 md:h-80 mb-10"
            ...
            >
                ...
                {showArrows && images.length > 1 && (
                    <>
                        <button
                            onClick={prevSlide}
                            className="absolute left-4 top-1/2 -translate-y-1/2 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 z-10"
                        ...
                        <button
                            onClick={nextSlide}
                            className="absolute right-4 top-1/2 -translate-y-1/2 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 z-10"
